...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <xsl:param name="siteHref" select="'https://srau.ejava.info/sites/ejava-ejb'"/>
  <xsl:param name="docHref" select="'https://srau.ejava.info/sites/ejava-ejb'"/>
  <xsl:param name="siteLinkText" select="'Building Service Tier with JavaEE/EJB'"/>
